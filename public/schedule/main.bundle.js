...
var ScheduleComponent = (function () {
    ...
    ScheduleComponent.prototype.shareOnTwitter = function (talkId, title, speakers) {
        ...
        var bodyText = "#DevoxxUK Checkout this talk  " + title + " by " + joinedSpeakers;
        var currentYear = new Date().getFullYear();
        var link = (window['talkLink'] || "https://cfp.devoxx.co.uk/2018/talk") + "/" + talkId;
