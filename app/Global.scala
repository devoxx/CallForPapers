...
object CronTask {
  ...
  def doEmailDigests() = {
    ...
    play.Logger.info(s"Scheduled akka system with ${delayForDaily} milliseconds i.e. ${delayForDaily hours} hours delay with an interval of every 24 hours (1 day) to send out Daily email digests.")
    ...
    play.Logger.info(s"Scheduled akka system with ${totalDelay} milliseconds i.e. ${totalDelay hours} hours delay with an interval of 7 days to send out Weekly email digests.")

    play.Logger.info(s"Email digests weekly delay : ${delayForWeekly} ms, i.e. ${delayForWeekly hours} hours and ${delayForDaily} ms, i.e. ${totalDelay hours} hours")
  }
